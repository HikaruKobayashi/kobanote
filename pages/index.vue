<template>
  <div class="w-full h-full">
    ...
    <ul class="w-full lg:w-10/12 mx-auto flex flex-wrap pb-12">
      <li class="w-11/12 lg:w-5/12 mt-8 mx-auto text-center p-4 lg:p-8 border-2 rounded-2xl border-gray-50 shadow-lg bg-white" v-for="b in blogs" :key="b.slug">
        <nuxt-link :to="b.slug">
